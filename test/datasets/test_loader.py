...
from orderdd.datasets import loader
...
class TestDatasetLoader(unittest.TestCase):
    ...
    def test_num_words(self):
        ...
        (x_train, _), _ = loader.load_data(num_words=1000)
    ...
    def test_skip_top(self):
        ...
        (x_train, _), _ = loader.load_data(skip_top=10, num_words=1000)
